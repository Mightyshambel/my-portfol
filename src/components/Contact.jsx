function Contact() {
    return <form className="mb-6 md:grid-cols-2 p-40 bg-cyan-950">
        <div className="max-w-lg mx-auto ">
            <p className="text-3xl text-center text-white">Contact me</p>
            <div>
                <label htmlFor="first_name" className="block mb-2 text-sm font-medium font-light text-gray-500 dark:text-white">First name</label>
            ...
            <div>
                <label htmlFor="last_name" className="block mb-2 text-sm font-medium font-light text-gray-500 dark:text-white">Last name</label>
            ...
            <div>
                <label htmlFor="company" className="block mb-2 text-sm font-medium font-light text-gray-500 dark:text-white">Message</label>
