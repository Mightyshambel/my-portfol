      ...
      <section className="bg-sky-100 dark:bg-gray-900">
        <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
            <div className="mr-auto place-self-center lg:col-span-7">
                ...
                <p className="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">I am a Creative Full-stack devloper specializing in building (and occasonally designing) exceptional digital experiences.Currently,I am focused on building websites using React and Angular on the front-end and Node js on the back-end.</p>
            ...
            <img className="max-w-lg  duration-300 rounded-lg  filter  hover:grayscale w-96 h-96" src="mightypic.jpg"  alt="mockup" />
            </div>                
        </div>
    </section>
